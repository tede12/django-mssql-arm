...
from mssql_arm.fields import AutoDecimalField, NCharField, BigAutoField
...
# New fields
class AutoDecimalModel(models.Model):
    id = AutoDecimalField(primary_key=True, max_digits=10, decimal_places=0, editable=False)
...
class NCharFieldModel(models.Model):
    a = NCharField(max_length=32)
