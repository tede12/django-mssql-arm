...
from mssql_arm.fields import DateTimeOffsetField, LegacyDateField, LegacyDateTimeField, LegacyTimeField, DateField, \
    DateTimeField, TimeField


class DatabaseOperations(BaseDatabaseOperations):
    compiler_module = 'mssql_arm.compiler'
    ...
    _convert_values_map = {
        ...
        'LegacyDateField': LegacyDateField(),
        'LegacyDateTimeField': LegacyDateTimeField(),
        'LegacyTimeField': LegacyTimeField(),
        'NewDateField': DateField(),
    ...
    @staticmethod
    def _new_value_to_db_datetime(value):
    ...
    @staticmethod
    def _new_value_to_db_time(value):
        if value is None or isinstance(value, six.string_types):
            return value
    ...
    @staticmethod
    def __to_truncated_datetime_string(value):
        """
    ...
    @staticmethod
    def _legacy_value_to_db_time(value):
        if value is None or isinstance(value, six.string_types):
            return value
    ...
    @staticmethod
    def bulk_insert_sql(fields, placeholder_rows):
    ...
    @staticmethod
    def convert_floatfield_value(value, expression, connection):
        if value is not None:
            value = float(value)
        return value

    @staticmethod
    def convert_uuidfield_value(value, expression, connection):
        if value is not None:
            value = uuid.UUID(value)
        return value

    @staticmethod
    def convert_booleanfield_value(value, expression, connection):
    ...
    @staticmethod
    def date_interval_sql(timedelta):
        """
    ...
    @staticmethod
    def _sql_flush_old(style, tables, sequences, allow_cascade=False):
        return sequences
