...
from mssql_arm.base import auto_field_types
...
class SQLInsertCompiler(compiler.SQLInsertCompiler, SQLCompiler):
    ...
    @staticmethod
    def fix_auto(sql, opts, fields, qn):
        # fix missing auto_fields
        auto_fields = [m for m in opts.fields if m.get_internal_type() in auto_field_types]
        if not opts.auto_field and auto_fields:
            opts.auto_field = auto_fields[0]
