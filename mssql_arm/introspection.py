...
from mssql_arm.consts import CONST
...
class DatabaseIntrospection(BaseDatabaseIntrospection):
    ...
    data_types_reverse = {
        ...
        CONST.SQL_BIGINT: 'BigIntegerField',
        # CONST.SQL_BINARY:            ,
        CONST.SQL_BIT: 'BooleanField',
        CONST.SQL_CHAR: 'CharField',
        CONST.SQL_DECIMAL: 'DecimalField',
        CONST.SQL_DOUBLE: 'FloatField',
        CONST.SQL_FLOAT: 'FloatField',
        CONST.SQL_GUID: 'TextField',
        CONST.SQL_INTEGER: 'IntegerField',
        CONST.SQL_LONGVARBINARY: 'BinaryField',
        # CONST.SQL_LONGVARCHAR:       ,
        CONST.SQL_NUMERIC: 'DecimalField',
        CONST.SQL_REAL: 'FloatField',
        CONST.SQL_SMALLINT: 'SmallIntegerField',
        CONST.SQL_SS_TIME2: 'TimeField',
        CONST.SQL_TINYINT: 'SmallIntegerField',
        CONST.SQL_TYPE_DATE: 'DateField',
        CONST.SQL_TYPE_TIME: 'TimeField',
        CONST.SQL_TYPE_TIMESTAMP: 'DateTimeField',
        CONST.SQL_VARBINARY: 'BinaryField',
        CONST.SQL_VARCHAR: 'TextField',
        CONST.SQL_WCHAR: 'CharField',
        CONST.SQL_WLONGVARCHAR: 'TextField',
        CONST.SQL_WVARCHAR: 'TextField',
    }
    ...
    def get_table_description(self, cursor, table_name, identity_check=True):
        ...
        for column in columns:
            ...
            if identity_check and self._is_auto_field(cursor, table_name, column[0]):
                if column[1] == CONST.SQL_BIGINT:
                    column[1] = SQL_BIGAUTOFIELD
                else:
                    column[1] = SQL_AUTOFIELD
            if column[1] == CONST.SQL_WVARCHAR and column[3] < 4000:
                column[1] = CONST.SQL_WCHAR
